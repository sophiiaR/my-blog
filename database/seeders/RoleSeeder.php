...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.users.index',
                            'description' => 'See users list'])->syncRoles([$role1]);
        Permission::create(['name' => 'admin.users.edit',
                            'description' => 'Assign role'])->syncRoles([$role1]);

        Permission::create(['name' => 'admin.categories.index',
                            'description' => 'See categories list'])->syncRoles([$role1, $role2]);
        ...
        Permission::create(['name' => 'admin.tags.index',
                            'description' => 'See tags list'])->syncRoles([$role1, $role2]);
        ...
        Permission::create(['name' => 'admin.posts.index',
                            'description' => 'See posts list'])->syncRoles([$role1, $role2]);
